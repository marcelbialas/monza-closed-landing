  ...
  return (
    <Container>
      ...
      <p>
        ...
        Datenschutz hat einen besonders hohen Stellenwert für uns. Eine Nutzung
      ...
      <p>
        ...
        Übereinstimmung mit den für die Monza Indoor Kart GmbH geltenden
      ...
      <p>
        Die Monza Indoor Kart GmbH hat als für die Verarbeitung Verantwortlicher
      ...
      <p>
        Die Datenschutzerklärung der Monza Indoor Kart GmbH beruht auf den
      ...
      <p>Dorstener Straße 360</p>
      <p>44653 Herne</p>
      <p>Deutschland</p>
      <p>Tel.: 02325988288</p>
      <p>E-Mail: monza@monza.de</p>
      <p>Website: www.monza.de</p>

      <h4>3. Cookies</h4>
      <p>
        Die Internetseiten der Monza Indoor Kart GmbH verwenden Cookies. Cookies
      ...
      <p>
        Durch den Einsatz von Cookies kann die Monza Indoor Kart GmbH den
      ...
      <p>
        Die Internetseite der Monza Indoor Kart GmbH erfasst mit jedem Aufruf
      ...
      <p>
        ...
        Monza Indoor Kart GmbH keine Rückschlüsse auf die betroffene Person.
        ...
        erhobenen Daten und Informationen werden durch die Monza Indoor Kart
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            Person die Löschung von personenbezogenen Daten, die bei der Monza
            Indoor Kart GmbH gespeichert sind, veranlassen möchte, kann sie sich
            hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
            Verantwortlichen wenden. Der Mitarbeiter der Monza Indoor Kart GmbH
            wird veranlassen, dass dem Löschverlangen unverzüglich nachgekommen
            wird.
          </p>

          <p>
            Wurden die personenbezogenen Daten von der Monza Indoor Kart GmbH
            öffentlich gemacht und ist unser Unternehmen als Verantwortlicher
            gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten
            verpflichtet, so trifft die Monza Indoor Kart GmbH unter
            ...
            die Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Monza
            Indoor Kart GmbH wird im Einzelfall das Notwendige veranlassen.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            bei der Monza Indoor Kart GmbH gespeichert sind, verlangen möchte,
            kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
            Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Monza
            Indoor Kart GmbH wird die Einschränkung der Verarbeitung
            veranlassen.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            betroffene Person jederzeit an einen Mitarbeiter der Monza Indoor
            Kart GmbH wenden.
          </p>
        </li>
        <li>
          ...
          <p>
            Die Monza Indoor Kart GmbH verarbeitet die personenbezogenen Daten
          ...
          <p>
            Verarbeitet die Monza Indoor Kart GmbH personenbezogene Daten, um
            ...
            steht. Widerspricht die betroffene Person gegenüber der Monza Indoor
            Kart GmbH der Verarbeitung für Zwecke der Direktwerbung, so wird die
            Monza Indoor Kart GmbH die personenbezogenen Daten nicht mehr für
          ...
          <p>
            ...
            Verarbeitung personenbezogener Daten, die bei der Monza Indoor Kart
            GmbH zu wissenschaftlichen oder historischen Forschungszwecken oder
          ...
          <p>
            ...
            Person direkt an jeden Mitarbeiter der Monza Indoor Kart GmbH oder
        ...
        <li>
          ...
          <p>
            ...
            der betroffenen Person, trifft die Monza Indoor Kart GmbH
      ...
      <h4>
        7. Datenschutzbestimmungen zu Einsatz und Verwendung von Adobe Analytics
        (Omniture) / Adobe Marketing Cloud
      </h4>
      <p>
        Der für die Verarbeitung Verantwortliche hat auf dieser Internetseite
        Komponenten des Unternehmens Adobe integriert. Adobe Analytics
        (Omniture) bzw. die Adobe Marketing Cloud (nachfolgend „Omniture“
        genannt) ist ein Instrument, das ein effizienteres Online-Marketing
        sowie eine Web-Analyse ermöglicht. Omniture ist ein Teil der Adobe
        Marketing Cloud. Die Adobe Marketing Cloud ermöglicht Echtzeitanalysen
        von Besucherströmen auf Internetseiten. Die Echtzeitanalysen umfassen
        Projektberichte und gestatten eine Ad-Hoc-Analyse der
        Internetseitenbesucher. Kundeninteraktionen werden so dargestellt, dass
        dem für die Verarbeitung Verantwortlichen ein besserer Überblick über
        die Onlineaktivitäten der Nutzer dieser Internetseite verschafft wird,
        indem die Daten in einfachen und interaktiven Dashboards angezeigt und
        in Berichte umgewandelt werden. Dies versetzt den für die Verarbeitung
        Verantwortlichen in die Lage, Informationen in Echtzeit zu erhalten und
        hierdurch auftretende Probleme schneller zu erkennen.
      </p>

      <p>
        Betreibergesellschaft dieser Services ist die Adobe Systems Software
        Ireland Limited, 4-6 Riverwalk, Citywest Business Campus, Dublin 24,
        Ireland.
      </p>

      <p>
        Omniture setzt ein Cookie auf dem informationstechnologischen System der
        betroffenen Person (Cookies wurden im Vorfeld bereits erklärt;
        entsprechendes kann oben nachgelesen werden). Der für die Verarbeitung
        Verantwortliche gewährleistet durch eine Servereinstellung, dass die an
        das Datencenter von Adobe übermittelten Tracking-Datensätze vor einer
        Geolokalisierung anonymisiert werden. Die Anonymisierung wird durch das
        Ersetzen des letzten Teils der IP-Adresse umgesetzt. Der für die
        Verarbeitung Verantwortliche hat serverseitig Einstellungen vorgenommen,
        aufgrund derer die IP-Adresse der betroffenen Person vor einer
        jeweiligen Verarbeitung für die Geolokalisierung und die
        Reichweitenmessung unabhängig voneinander anonymisiert werden. Adobe
        wird im Auftrag des für die Verarbeitung Verantwortlichen die über
        unsere Internetseite gewonnenen Daten und Informationen dazu nutzen das
        Nutzerverhalten der betroffenen Person auszuwerten. Ferner wird Adobe
        die Daten nutzen, um in unserem Auftrag Reports über die
        Nutzeraktivitäten zu erstellen sowie weitere Dienstleistungen für unser
        Unternehmen zu erbringen, die im Zusammenhang mit der Nutzung unserer
        Internetseite stehen. Die IP-Adresse der betroffenen Person wird durch
        Adobe nicht mit anderen personenbezogenen Daten zusammengeführt.
      </p>
      ...
      <p>
        ...
        Omniture ein Cookie auf dem informationstechnologischen System der
        betroffenen Person setzt. Zudem können die von Omniture bereits
      ...
      <p>
        ...
        Erfassung der durch das Adobe-Cookie erzeugten, auf eine Nutzung dieser
        Internetseite bezogenen Daten sowie der Verarbeitung dieser Daten durch
        Adobe zu widersprechen und eine solche zu verhindern. Hierzu muss die
        betroffene Person den Abmelde-Button unter dem Link
        ...
        wird auf dem von der betroffenen Person genutzten
        informationstechnologischen System abgelegt. Werden die Cookies auf dem
        System der betroffenen Person nach einem Widerspruch gelöscht, muss die
        betroffene Person den Link erneut aufrufen und einen neuen
        Opt-Out-Cookie setzen.
      </p>

      <p>
        Mit der Setzung des Opt-Out-Cookies besteht jedoch die Möglichkeit, dass
        die Internetseiten des für die Verarbeitung Verantwortlichen für die
        betroffene Person nicht mehr vollumfänglich nutzbar sind.
      </p>
      ...
      <p>
        ...
        Google-Dienste verantwortlich. <br />
        <br />
